...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 14:07:38 2021
...
def processVideo():
    ...
    cap = cv2.VideoCapture(('./test_videos/solidWhiteRight.mp4'))#打开视频
    ...
    # temp=pipeline(img)
        if writer is None:
            ...
            writer = cv2.VideoWriter('check1.mp4', fourcc, 30, (frame.shape[1], frame.shape[0]), True)
